...
const configureClient = async () => {
  ...
  auth0 = await createAuth0Client({
    domain: config.domain, // App domain
    client_id: config.clientId, // App id
    audience: config.audience, // Unique identifier for the API.
  });
};
...
const updateUI = async () => {
  ...
  if (isAuthenticated) {
    ...
    document.getElementById("avatar-img").src =
      pictureUrl ||
      "https://icon-library.net/images/icon-of-music/icon-of-music-8.jpg";
