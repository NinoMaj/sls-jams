$(document).ready(function () {
  ...
  refreshVoteCounts();
  document
    .getElementsByClassName("ui red button")[0]
    .addEventListener("click", recordVote);
});

var vote_endpoint =
  "https://rxda5s5gx6.execute-api.us-east-1.amazonaws.com/dev/song/vote";
var get_votes_endpoint =
  "https://rxda5s5gx6.execute-api.us-east-1.amazonaws.com/dev/votes";
...
function recordVote() {
  if (document.getElementsByClassName("item active selected")[0]) {
    var selectedSong = document
      .getElementsByClassName("item active selected")[0]
